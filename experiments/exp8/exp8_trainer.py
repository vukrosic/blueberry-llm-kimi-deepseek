...
def main():
    ...
    base_config = MoEModelConfig(
        max_steps=1500,  # 1500 steps per model for comprehensive testing
        batch_size=16,
        max_tokens=100000,
    ...
    print(f"   Steps: {base_config.max_steps} (1500 steps per model)")
    ...
    results = trainer.run_reduced_test(test_steps=1500)
